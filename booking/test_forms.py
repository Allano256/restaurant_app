...
class TestReserveForm(TestCase):
    ...
    def test_form_is_valid(self):
        ...
        self.assertTrue(reserve_form.is_valid(), msg='Form is not valid')


class TestReserveForm(TestCase):
    """
    Test for all fields,giving an empty email field.
    """
    ...
    def test_form_is_invalid(self):
        ...
        self.assertFalse(reserve_form.is_valid(), msg='Form is  valid')
...
class TestEditForm(TestCase):
    ...
    def test_edit_reserve_form_is_valid(self):
        ...
        self.assertTrue(editreserve_form.is_valid(), msg='Form is not valid')
...
class TestEditForm(TestCase):
    ...
    def test_edit_reserve_form_is_invalid(self):
        ...
        editreserve_form = EditForm(valid_data)
        self.assertFalse(editreserve_form.is_valid(), msg='Form is  valid')
