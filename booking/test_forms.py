...
class TestReserveForm(TestCase):
    ...
    def test_form_is_valid(self):
        ...
        self.assertTrue(
            reserve_form.is_valid(), msg="Reservation form is not valid")
...
class TestReserveForm(TestCase):
    ...
    def test_form_is_invalid(self):
        ...
        self.assertFalse(
            reserve_form.is_valid(), msg="Reservation form is  valid")
...
class TestEditForm(TestCase):
    ...
    def test_edit_reserve_form_is_valid(self):
        ...
        editreserve_form = EditForm(
            valid_data)
        self.assertTrue(
             editreserve_form.is_valid(), msg="Edit form is not valid")
...
class TestEditForm(TestCase):
    ...
    def test_edit_reserve_form_is_invalid(self):
        invalid_data = {
            ...
            "date_of_month": date.today().isoformat(),
            "time_of_day": "18:30",
            "message_to_restaurant":
            "Looking forward to visiting!",
        }
        editreserve_form = EditForm(invalid_data)
        self.assertFalse(
             editreserve_form.is_valid(), msg="Edit form is  valid")
